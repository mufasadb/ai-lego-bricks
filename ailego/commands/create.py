        ...
        "template": {
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "type": "input",
                    "config": {
                        "prompt": "What would you like to know about the document?"
                    },
                    "outputs": ["question"],
                },
                {
                ...
                },
                {
                    ...
                    "inputs": {
                        ...
                        "context": {
                            "from_step": "retrieve_relevant",
                            "field": "relevant_chunks",
                        },
                    },
                    "config": {
                ...
                },
                {
                    "id": "output",
                    "type": "output",
                    "inputs": {"result": {"from_step": "analyze", "field": "analysis"}},
                },
            ],
        },
    },
        ...
        "template": {
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "inputs": {
                        "result": {
                            "from_step": "generate_structured_output",
                            "field": "structured_report",
                        }
                    },
                },
            ],
        ...
        "template": {
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "type": "input",
                    "config": {
                        "prompt": "What specific question do you have about the image?"
                    },
                    "outputs": ["question"],
                },
                {
...
def _customize_agent_interactive(
    ...
    for step in config.get("steps", []):
        if step.get("type") == "llm_chat" and "system_message" in step.get(
            "config", {}
        ):
    ...
    if agent_type == "streaming":
        ...
        memory_provider = Prompt.ask(
            "Memory provider", choices=["supabase", "neo4j", "auto"], default="auto"
        )
...
def _configure_tts_step(config: Dict[str, Any]):
    ...
    tts_provider = Prompt.ask(
        "TTS Provider", choices=["openai", "google", "coqui", "auto"], default="auto"
    )
...
def _show_available_templates():
    ...
    for agent_type, template_info in AGENT_TEMPLATES.items():
        table.add_row(agent_type, template_info["name"], template_info["description"])
