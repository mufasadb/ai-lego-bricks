...
def run_workflow(
    ...
    if verbose:
        console.print(f"[blue]Loading workflow: {workflow_config.get('name', 'Unknown')}[/blue]")
        console.print(f"[blue]Description: {workflow_config.get('description', 'No description')}[/blue]")
...
def _display_results(result: Dict[str, Any], output_file: Optional[str], verbose: bool):
    ...
    if output_file:
        try:
            ...
            console.print(f"[yellow]Warning: Could not save results to file: {e}[/yellow]")
...
def list_available_workflows():
    ...
    if workflows:
        ...
        console.print("[blue]Try running 'ailego init <project-name>' to create a new project[/blue]")