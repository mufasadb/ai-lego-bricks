...
def _show_project_templates():
    ...
    console.print(table)
    console.print("[blue]Usage: ailego init <project-name> --template <template-name>[/blue]")
...
def show_template_details(template_type: str):
    ...
    if template_type in AGENT_TEMPLATES:
        ...
        console.print("[blue]Use 'ailego list-templates' to see available templates[/blue]")
