...
def create_generation_service(provider: str = "auto", **kwargs) -> Any:
    ...
    """
    from llm.generation_service import create_generation_service as _create_generation_service
...
def create_conversation_service(provider: str = "auto", **kwargs) -> Any:
    ...
    """
    from chat.conversation_service import create_conversation_service as _create_conversation_service
