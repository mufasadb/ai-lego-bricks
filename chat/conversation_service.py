...
class ConversationService:
    ...
    def get_conversation_summary(self) -> str:
        ...
        for message in self.conversation.messages:
            ...
            summary_parts.append(f"[{timestamp_str}] {message.role.title()}: {message.content}")
    ...
    def search_messages(self, query: str, role: Optional[str] = None) -> List[ConversationMessage]:
    ...
    def _export_as_markdown(self) -> str:
        ...
        for i, message in enumerate(self.conversation.messages):
            ...
            markdown_parts.append(f"### {role_emoji} {message.role.title()} ({timestamp_str})")
    ...
    def get_conversation_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "duration_minutes": (self.conversation.updated_at - self.conversation.created_at).total_seconds() / 60
        }


# Convenience functions for quick conversation creation
def create_conversation(provider: LLMProvider, model: Optional[str] = None, **kwargs) -> ConversationService:
    """
