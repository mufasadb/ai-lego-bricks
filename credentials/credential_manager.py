...
class CredentialManager:
    ...
    def __init__(
        self, credentials: Optional[Dict[str, str]] = None, load_env: bool = True
    ):
        """
    ...
    def validate_required_credentials(
        self, required_keys: list[str], service_name: str = "service"
    ) -> Dict[str, str]:
        """
...
def create_credential_manager(
    credentials: Optional[Dict[str, str]] = None, load_env: bool = True
) -> CredentialManager:
    """
