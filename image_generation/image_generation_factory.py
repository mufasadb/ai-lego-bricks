...
class ImageGenerationServiceFactory:
    ...
    @staticmethod
    def _create_config(
        provider: ImageGenerationProvider, **kwargs
    ) -> ImageGenerationConfig:
    ...
    def get_available_providers() -> Dict[str, bool]:
        ...
        providers["stability_ai"] = bool(
            credential_manager.get_credential("STABILITY_API_KEY")
        )
        providers["google"] = bool(
            credential_manager.get_credential("GOOGLE_AI_STUDIO_KEY")
        )
...
def create_image_generation_service(
    ...
    return ImageGenerationServiceFactory.create_image_generation_service(
        provider, **kwargs
    )
...
def quick_image_generation(prompt: str, provider: str = "auto", **kwargs) -> str:
