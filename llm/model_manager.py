...
class ModelManager:
    ...
    def switch_model(self, client: Union[TextLLMClient, VisionLLMClient], new_model: str) -> bool:
        """
    ...
    def get_current_model(self, client: Union[TextLLMClient, VisionLLMClient]) -> Optional[str]:
        """
    ...
    def get_models_by_type(self) -> Dict[str, List[str]]:
        ...
        for model in models:
            ...
            elif any(text_indicator in model_lower for text_indicator in ["llama", "mistral", "gemma", "phi", "qwen", "neural", "chat"]):
