...
class ThinkingTokensService:
        ...
        for delimiter in self.delimiters:
            ...
            if closing_pattern == "\n\n":
                ...
                if end_pos == -1:
                    ...
                    thinking_content = response[start_pos + len(delimiter):end_pos].strip()
    ...
    def format_extracted_response(self, result: ThinkingTokensResult) -> Dict[str, Any]:
        ...
        if result.processing_mode == ThinkingTokensMode.EXTRACT and result.thinking_content:
