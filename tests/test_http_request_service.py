...
class TestHttpRequestService:
    ...
    def test_resolve_credentials_bearer(self, service):
        ...
        config = HttpRequestConfig(url="https://example.com", auth_type="bearer")
    ...
    def test_resolve_credentials_basic(self, service):
        ...
        config = HttpRequestConfig(url="https://example.com", auth_type="basic")
