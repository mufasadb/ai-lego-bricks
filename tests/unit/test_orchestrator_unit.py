"""
Unit tests for Agent Orchestrator using VCR cassettes.

These tests use recorded cassettes from integration tests for fast execution
...
class TestAgentOrchestratorUnit:
    ...
    def test_basic_chat_agent(self, orchestrator, examples_dir):
        """Test the basic chat agent example using VCR."""
    ...
    @pytest.mark.vcr
    @pytest.mark.unit
    def test_simple_ollama_chat(self, orchestrator, examples_dir):
        """Test the simple ollama chat example using VCR."""
    ...
    @pytest.mark.vcr
    @pytest.mark.unit
    def test_multi_turn_chat_demo(self, orchestrator, examples_dir):
        """Test the multi-turn chat demo using VCR."""
    ...
    @pytest.mark.vcr
    @pytest.mark.unit
    def test_streaming_agent(self, orchestrator, examples_dir):
        """Test streaming agent functionality using VCR."""
    ...
    @pytest.mark.vcr
    @pytest.mark.unit
    def test_http_request_examples(self, orchestrator, examples_dir):
        """Test HTTP request examples using VCR."""
    ...
    @pytest.mark.unit
    @pytest.mark.slow
    def test_complex_workflow_agent(self, orchestrator, examples_dir):
        """Test complex workflow agent using VCR."""
    ...
    @pytest.mark.unit
    @pytest.mark.slow
    def test_parallel_workflow_example(self, orchestrator, examples_dir):
        """Test parallel workflow execution using VCR."""
    ...
    @pytest.mark.vcr
    @pytest.mark.unit
    def test_text_analyzer_specialist(self, orchestrator, examples_dir):
        """Test text analyzer specialist agent using VCR."""
    ...
    @pytest.mark.vcr
    @pytest.mark.unit
    def test_dollar_amount_extraction_agent(self, orchestrator, examples_dir):
        """Test dollar amount extraction agent using VCR."""
    ...
    @pytest.mark.unit
    @pytest.mark.slow
    def test_multi_agent_coordinator(self, orchestrator, examples_dir):
        """Test multi-agent coordinator using VCR."""
    ...
    def test_additional_agents(self, orchestrator, examples_dir, example_filename):
        """Test additional agent examples parametrically using VCR."""
    ...
    @pytest.mark.unit
    @pytest.mark.slow
    def test_tool_functionality_across_providers(self, orchestrator, examples_dir):
        """Test tool functionality across different providers using VCR."""
    ...
    @pytest.mark.vcr
    @pytest.mark.unit
    def test_debug_mcp_tool_calling_reliability(self, orchestrator, examples_dir):
        """Test MCP tool calling reliability debugging using VCR."""
