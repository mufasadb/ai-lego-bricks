...
class OpenAIAdapter(ProviderAdapter):
    ...
    def format_tools_for_request(self, tools: List[ToolSchema]) -> Dict[str, Any]:
        ...
        return {"tools": [tool.to_openai_format() for tool in tools]}
...
class AnthropicAdapter(ProviderAdapter):
    ...
    def format_tools_for_request(self, tools: List[ToolSchema]) -> Dict[str, Any]:
        ...
        return {"tools": [tool.to_anthropic_format() for tool in tools]}
...
class GeminiAdapter(ProviderAdapter):
    ...
    def format_tool_choice(self, tool_choice: Optional[ToolChoice]) -> Any:
        ...
        if tool_choice:
            return {"function_calling_config": {"mode": tool_choice.to_gemini_format()}}
...
class OllamaAdapter(ProviderAdapter):
    ...
    def format_tools_for_request(self, tools: List[ToolSchema]) -> Dict[str, Any]:
        ...
        return {"tools": [tool.to_ollama_format() for tool in tools]}
