...
class ToolSchema(BaseModel):
    ...
    def to_openai_format(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "function": {
                ...
                "parameters": (
                    self._parameter_to_json_schema(self.parameters)
                    if self.parameters
                    else {}
                ),
            },
    ...
    def _parameter_to_json_schema(
        self, param: Optional[ToolParameter]
    ) -> Dict[str, Any]:
...
class ToolResult(BaseModel):
    ...
    def to_openai_format(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "role": "tool",
            "content": (
                str(self.result) if self.error is None else f"Error: {self.error}"
            ),
        }
            ...
            "parts": [
                {
                    "functionResponse": {
                        "name": self.name,
                        "response": (
                            self.result if self.error is None else {"error": self.error}
                        ),
                    }
                }
            ],
...
class ToolChoice(BaseModel):
    ...
    def to_anthropic_format(self) -> Union[str, Dict[str, Any]]:
        ...
        if self.type == ToolChoiceType.AUTO:
            ...
            return {"type": "tool", "name": self.function_name}
        return "auto"
