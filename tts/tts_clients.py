        ...
        if self._speakers_cache is None:
            try:
                response = requests.get(
                    f"{self.server_url}/studio_speakers",
                    timeout=self.timeout
                )
...
class GoogleTTSClient(TTSClient):
    ...
    def text_to_speech(self, text: str, **kwargs) -> TTSResponse:
        ...
        try:
            ...
            voice_config = texttospeech.VoiceSelectionParams(
                ...
                ssml_gender=getattr(texttospeech.SsmlVoiceGender, 
                                  kwargs.get("ssml_gender", "NEUTRAL"))
            )
    ...
    def _get_audio_encoding(self):
        ...
        try:
            ...
            return format_mapping.get(self.config.output_format, texttospeech.AudioEncoding.MP3)
        except ImportError:
